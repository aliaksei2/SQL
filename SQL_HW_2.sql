...
select employee_salary.employee_id, employees.employee_name
...
on roles_employee.employee_id = employee_salary.id 
join salary 
on employee_salary.salary_id = salary.id
...
on roles_employee.role_id = roles.id 
join employee_salary
on roles_employee.employee_id = roles_employee.id 
join salary 
